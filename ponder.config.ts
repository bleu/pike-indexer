...
import { CONTRACT_ADDRESSES } from './src/utils/addressBook';

const HOUR = 60 * 60;

const USE_FACTORY = process.env.USE_FACTORY !== 'false';
...
const getChainConfigs = (): Record<ChainId, ChainConfig> => {
  if (process.env.NODE_ENV === 'test' && process.env.TARGET_CHAIN_ID) {
